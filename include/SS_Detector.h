...
public:
	...
	SS_Detector(System::String^ strInputFileName, System::String^ strDirName, int patIdx, int montage, std::vector<std::string> *selectedUnipolarChanels, std::vector<std::string> *selectedBipolarChanels, std::string &eoiName, 
		bool useChannsFileBool, System::Double startTime, System::Double endTime, bool compareDetectionsWithVisalMarks, bool useScalpEEG);
