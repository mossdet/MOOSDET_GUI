...
#ifndef __BinaryReader__H__
#define __BinaryReader__H__
...
{
public:
	BinaryReader(const std::string strFilename, std::vector<std::string > selectedUnipolarChanns, std::vector<std::string > selectedBipolarChanns, bool useScalpEEG);
	...
	void setSizeOfDouble(double sizeOfDouble) { m_sizeOfDouble = sizeOfDouble; }
