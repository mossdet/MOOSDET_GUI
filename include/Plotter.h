...
public:
	...
	static void Plotter::plotXY(std::vector<double> &x, std::vector<double> &y, std::string &wdwTitle, double xtics, double ytics);
	static void Plotter::writeVectorsToFile(std::vector<double> &x, std::vector<double> &y, std::string &filename);
